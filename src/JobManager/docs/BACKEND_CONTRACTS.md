...
| BE-006 | Will AOI Feature Service require authentication?        |   Open | Important for config/security.                          |
| BE-007 | Which AOI fields are stable identifiers?                |   Open | Required for relations and popups.                      |
