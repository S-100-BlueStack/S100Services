# PM-001 Product Catalogue Cross-Stack Hardening Review
...
6. mandatory ArcGIS/Product Catalogue initialization failure is swallowed, allowing a partially initialized API process to start.
...
### PM-001-BE-003 — Mandatory Product Catalogue initialization failure is swallowed
...
- search all Product Catalogue source-of-truth docs for old baseline references;
...
```text
Align Product Catalogue documentation baselines after PM-001
```
