...
Current reviewed repository baseline: `c1ed794374e56383a7362f3eadb2d16b07dfdb17`.
...
| FI-032 | Main map navigation              | Open workspaces in new tabs and correct false popup-blocked notices       | Implemented; manual verification pending | Main-map launches of Dashboard/Analyze/Review use base-aware semantic links or synchronous action launches in a new tab; navigation from Dashboard/Analyze/Review remains same-tab. Product Collection preserves canonical Analyze/Review composition and reports a blocked popup only when the actual open result fails. FI-026/FI-028/FI-031 behavior is unchanged. See `ui-ux-design-backlog.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
14. FI-012, FI-009, FI-013, FI-014, FI-015, FI-017, FI-021, FI-022, FI-026, FI-028 and FI-031 are complete; the latest accepted frontend baseline is `c1ed794374e56383a7362f3eadb2d16b07dfdb17`.
...
25. FI-031 non-empty source startup is manually accepted at `c1ed794374e56383a7362f3eadb2d16b07dfdb17`. FI-032 Main-map workspace navigation is implemented with manual verification pending; FI-027 navbar search still requires its short design pass after the shared navbar structure is stable.
