...
| FI-038 | Review                           | Default all content types on and add bulk content toggles                 | Ready                                    | Enable History/IC-ENC/Validation by default and add workspace-level enable/disable-all controls while preserving per-Product overrides across refreshes. See `ui-ux-design-backlog.md`. |
...
29. FI-036/FI-041 remain accepted at `9c07f8a7fb93cd80bbbab59a3d47719e3667863c`, and FI-037 Review content layout/empty states is complete and manually accepted at `ee37173e31525d990412b3dff7205ec5af4371e8`. Continue with FI-038 defaults/bulk toggles, then FI-039 incremental composition loading.
