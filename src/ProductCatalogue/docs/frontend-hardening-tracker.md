...
Current reviewed repository baseline: `1a77af904ec1a41726bcec357b72610c74e793ca`.
...
| FI-040 | Main map / Accessibility         | Add modifier-selection keyboard equivalent and discoverability            | Implemented; manual verification pending | Map-focused Ctrl/Cmd+Enter activates only the current transient highlighted Product after current layer/Graphic revalidation through the shared direct-selection/popup path. A compact contextual hint exposes both Ctrl/Cmd-click and Ctrl/Cmd+Enter. Normal overlap selection, Product Collection and source-aware stale-state safeguards remain unchanged. See `ui-ux-design-backlog.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
22. FI-021 is manually accepted at `32efa496f978e20baee834f0becdb95bdadadd98`; FI-040 now implements its separate keyboard-equivalent activation and visible shortcut discoverability follow-up, with manual verification still pending.
...
FI-021 itself remains the accepted pointer-only contract. FI-040 separately implements the original keyboard-equivalent activation and visible discoverability requirements while preserving normal overlap-picker access; FI-040 manual verification is still pending.
