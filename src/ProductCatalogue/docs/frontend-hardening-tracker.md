...
| FI-037 | Review                           | Reduce Product-content density and nested report scrolling                | Ready                                    | Make History sizing more content-sensitive, let Product/content own scrolling, and simplify duplicated IC-ENC/validation empty-state copy without collapsing materially different backend states. See `ui-ux-design-backlog.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
29. FI-036 Review sidebar compaction and FI-041 Product-list scroll/focus preservation are complete and manually accepted at `9c07f8a7fb93cd80bbbab59a3d47719e3667863c`. Continue with FI-037 content layout/empty states, then FI-038 defaults/bulk toggles and FI-039 incremental composition loading.
