...
Current reviewed repository baseline: `9c07f8a7fb93cd80bbbab59a3d47719e3667863c`.
...
| FI-037 | Review                           | Reduce Product-content density and nested report scrolling                | Implemented; manual verification pending | History now sizes to content up to a viewport-aware 240–500 px cap and retains the only intentional content-card scroller. IC-ENC and Validation bodies render at natural height so the Product column owns overflow. Concise body copy is paired with distinct `Unavailable`, `Failed`, empty-count and content-count header states; validation diagnostic downloads remain unchanged. FI-022/FI-024 loading and source resolution plus FI-036/FI-041 interaction contracts are unchanged. See `ui-ux-design-backlog.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
29. FI-036 Review sidebar compaction and FI-041 Product-list scroll/focus preservation are complete and manually accepted at `9c07f8a7fb93cd80bbbab59a3d47719e3667863c`. FI-037 content layout/empty-state work is implemented with manual verification pending. Continue with FI-038 defaults/bulk toggles and FI-039 incremental composition loading only after FI-037 acceptance.
