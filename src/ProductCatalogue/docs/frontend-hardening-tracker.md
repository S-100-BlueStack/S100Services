...
Current reviewed repository baseline: `01f22a605e8e4d29a8da187306af1dc04b8540ef`.
...
| FI-034 | Dashboard                        | Auto-apply valid filter changes                                           | Implemented; manual verification pending | Apply is removed. Committed valid date/time changes auto-apply once through the existing request lifecycle; incomplete/invalid drafts neither request nor update the route. Optional To clearing applies the open-ended range. Discrete filters remain immediate, search remains debounced, paging/cursors reset, and sort/page size persist. Last-successful results and FI-033 `HH:MM` survive failure/stale completion; manual Refresh uses the applied range. Dashboard History and FI-032 navigation are unchanged. Saved filter presets remain deferred. See `ui-ux-design-backlog.md`.                                                                                                                                                                                                                                                                                                                                                                                                                               |
| FI-035 | Analyze                          | Compact the sidebar and align scrollbar/list presentation                 | Implemented; manual verification pending | Removed redundant visible copy while preserving accessible/contextual messaging, reduced spacing/list height/sidebar width, renamed Product list to Products, and introduced the neutral shared `pc-scrollbar` contract while preserving FI-022/FI-024 behavior. See `ui-ux-design-backlog.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
14. FI-012, FI-009, FI-013, FI-014, FI-015, FI-017, FI-021, FI-022, FI-026, FI-028, FI-031, FI-032 and FI-033 are complete; the latest accepted frontend baseline is `01f22a605e8e4d29a8da187306af1dc04b8540ef`.
...
25. FI-031 non-empty source startup remains accepted at `c1ed794374e56383a7362f3eadb2d16b07dfdb17`, FI-032 Main-map workspace navigation remains accepted at `11491d15272b165b63da58dece83cb0c0776077b`, and FI-033 Dashboard visual compaction is manually accepted at `01f22a605e8e4d29a8da187306af1dc04b8540ef`. FI-034 Dashboard automatic filtering is implemented with manual verification pending; FI-027 navbar search still requires its separate short design pass.
26. Keep FI-034 automatic range application on the accepted FI-033 compact toolbar and complete its browser verification before marking it Done.
