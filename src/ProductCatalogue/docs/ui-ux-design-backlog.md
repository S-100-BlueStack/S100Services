...
Documentation baseline: `c1ed794374e56383a7362f3eadb2d16b07dfdb17`  
...
| FI-032 | Main map navigation             | Open Dashboard, Analyze, and Review in new tabs from the Main map and fix false popup-blocked notices | Implemented; manual verification pending  | Main-map workspace links/actions open new tabs through one route-aware policy; workspace-to-workspace navigation stays same-tab. Product Collection preserves canonical composition, and blocked-popup notices follow the actual open result.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
4. FI-031 non-empty source startup is complete and manually accepted at `c1ed794374e56383a7362f3eadb2d16b07dfdb17`; FI-032 Main-map workspace navigation is the next bounded behavior item.
