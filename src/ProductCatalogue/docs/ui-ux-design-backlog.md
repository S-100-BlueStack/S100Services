...
| FI-037 | Review                          | Reduce Product-content density, simplify empty states, and remove nested report scrolling             | Ready                                     | Preserve independent History/IC-ENC/validation failures and truthful unavailable states.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
