...
Documentation baseline: `e235a15b6d86dc3c5313a4a151fa8c5146612a3a`  
...
| FI-036 | Review                          | Compact Review sidebar controls and move Refresh above Products                                       | Implemented; manual verification pending  | Removed redundant visible Review/sidebar Product-picker copy while preserving accessible and contextual messaging. Review explicitly uses an anchored Product-picker results overlay, and the existing single manual Refresh action is icon-only in the `Products` header immediately before its counter. Product composition, toggles, FI-022 freshness, source-aware resolution, routing, failures and shared scrolling remain unchanged.                                                                                                                                                                                                                                                                                                                                                |
