...
Documentation baseline: `9c07f8a7fb93cd80bbbab59a3d47719e3667863c`  
...
| FI-037 | Review                          | Reduce Product-content density, simplify empty states, and remove nested report scrolling             | Implemented; manual verification pending  | History uses content-sensitive sizing with a viewport-aware cap; IC-ENC/Validation bodies no longer own vertical scrolling. Header status/count plus one concise body message preserves unavailable, failed and available-empty distinctions, while validation artifact links remain available when content exists.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
9. FI-036 and FI-041 are complete and manually accepted at `9c07f8a7fb93cd80bbbab59a3d47719e3667863c`. Continue the controlled Review sequence with FI-037, then FI-038 and FI-039.
