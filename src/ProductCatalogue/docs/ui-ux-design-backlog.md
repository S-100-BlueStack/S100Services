...
Documentation baseline: `32e3f17049491298acfb31a5448def0284484987`  
...
| FI-042 | Main map / Filters              | Align Filter panel scrollbar styling                                                                  | Implemented; manual verification pending  | Reuses the accepted FI-035 neutral shared `pc-scrollbar` contract on the Filter panel outer scroller and generated checkbox option lists such as Status. Existing overflow ownership, filtering state, counts, persistence, wheel/keyboard behavior and public Calcite boundaries are unchanged.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- Browser-specific scrollbar rendering, including overlay scrollbars, remains subject to manual verification.
...
8. FI-042 Filter-panel scrollbar consistency is implemented using the accepted shared treatment; complete manual browser verification before marking it Done.
