...
| FI-038 | Review                          | Enable all Review content types by default and add bulk content toggles                               | Ready                                     | Bulk controls must coexist with per-Product controls and preserve user-selected state after subsequent refreshes. |
