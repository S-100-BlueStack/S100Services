...
function createProductReviewColumn(productItem, product) {
  ...
  header.className = "pc-review-column__header";
...
function createContentCardShell({ product, contentType, title, status }) {
  ...
  statusElement.className = "pc-review-content-card__status";
...
function createCardActionButton({ label, text, onClick }) {
  ...
  button.type = "button";
  button.className = "pc-review-content-card__action-button";
...
function createCompactHistoryList(events) {
  ...
  list.className = "pc-review-history-list";
...
function createCompactHistoryItem(event) {
  ...
  details.className = "pc-review-history-event";
  ...
  title.className = "pc-review-history-event__title";
  ...
  const body = document.createElement("div");
  body.className = "pc-review-history-event__body";

  if (event.description) {
    const description = document.createElement("p");
    description.className = "pc-review-history-event__description";
  ...
  if (!body.hasChildNodes()) {
    ...
    empty.className = "pc-review-history-event__description";
...
function createEventDetails(details) {
  ...
  list.className = "pc-review-history-event__details";
