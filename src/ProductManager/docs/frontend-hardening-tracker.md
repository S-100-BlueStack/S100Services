...
| FH-024 | P2       | Loader     | Harden loader/progress session state cleanup                                                 | Todo   |                                          | Prevent stale loader show/hide frames and delayed failure timeouts from affecting later loader sessions.                                                                              |
