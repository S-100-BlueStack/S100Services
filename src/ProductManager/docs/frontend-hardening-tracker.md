...
| ------ | -------- | --------- | ------------------------------------------------------------------------ | ------ | ------------- | ---------------------------------------------------------------------------------------------------------------------- |
| FH-001 | P0       | Tooling   | Add a real lint/check baseline in addition to Prettier formatting        | Done   | <commit-hash> | Added ESLint script and check script.                                                                                  |
| FH-002 | P0       | Tooling   | Verify ESLint config format and package scripts                          | Done   | <commit-hash> | Replaced invalid JSON config with ESLint flat config.                                                                  |
...
| FH-004 | P0       | API       | Remove, rename, or isolate old mock/random API code if still present     | Done   | <commit-hash> | Verified current `productApi.js` has no mock/random API behavior and no hardcoded API base URL. No code change needed. |
...
| FH-015 | P2       | Config    | Add or update `.env.example` and document dev/prod API base behavior     | Done   | <commit-hash> | Added env example and preserved current dev/prod API behavior.                                                         |
