...
export function createJobLayers() {
  ...
  const pointLayer = createJobPointLayer({
    id: "data-catalogue-job-point-layer",
    title: "Job points",
    visible: true,
...
function createJobPolygonLayer() {
  return new FeatureLayer({
    id: "data-catalogue-job-polygon-layer",
    title: "Job polygons",
    source: [],
