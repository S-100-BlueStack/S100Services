...
const AOI_JOB_SUMMARY_POPUP_CONTENT_ID = "data-catalogue-aoi-job-summary";
...
function createSummaryContainer() {
  ...
  containerElement.className = "data-catalogue-aoi-popup-summary";
...
function renderMessageState({ containerElement, message }) {
  ...
  messageElement.className = "data-catalogue-aoi-popup-summary__message";
...
function renderSummaryState({ containerElement, summary, filtersActive }) {
  ...
  metricsElement.className = "data-catalogue-aoi-popup-summary__metrics";
  ...
  hintElement.className = "data-catalogue-aoi-popup-summary__hint";
...
function createTitleElement() {
  ...
  titleElement.className = "data-catalogue-aoi-popup-summary__title";
...
function createMetricElement({ label, value }) {
  ...
  metricElement.className = "data-catalogue-aoi-popup-summary__metric";

  const valueElement = document.createElement("span");
  valueElement.className = "data-catalogue-aoi-popup-summary__metric-value";
  valueElement.textContent = String(value);

  const labelElement = document.createElement("span");
  labelElement.className = "data-catalogue-aoi-popup-summary__metric-label";
