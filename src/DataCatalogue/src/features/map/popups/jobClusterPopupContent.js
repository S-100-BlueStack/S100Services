...
export function createJobClusterPickerContent({ view } = {}) {
  return new CustomContent({
    ...
    creator(event) {
      ...
      container.className = "data-catalogue-cluster-picker";
...
function renderClusterPicker({ container, view, features, location }) {
  ...
  listElement.className = "data-catalogue-cluster-picker__list";
...
function createClusterJobButton({ view, feature, location }) {
  ...
  button.type = "button";
  button.className = "data-catalogue-cluster-picker__item";

  const priorityMarker = document.createElement("span");
  priorityMarker.className = "data-catalogue-cluster-picker__priority-marker";
  priorityMarker.dataset.priority = normalizeOptionalString(
    feature.attributes?.[JOB_LAYER_FIELD.PRIORITY]
  );

  const content = document.createElement("span");
  content.className = "data-catalogue-cluster-picker__content";

  const title = document.createElement("span");
  title.className = "data-catalogue-cluster-picker__job-title";
  title.textContent = getFeatureTitle(feature);

  const subtitle = document.createElement("span");
  subtitle.className = "data-catalogue-cluster-picker__job-subtitle";
...
function renderClusterPickerMessage({ container, message }) {
  ...
  messageElement.className = "data-catalogue-cluster-picker__message";
