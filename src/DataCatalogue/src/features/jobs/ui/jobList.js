...
function createJobsRefreshedEvent({ source, jobs } = {}) {
  return new CustomEvent("data-catalogue:jobs-refreshed", {
    bubbles: true,
    detail: {
...
function createAoiFilterClearedEvent() {
  return new CustomEvent("data-catalogue:aoi-filter-cleared", {
    bubbles: true,
  });
}

function createJobSelectionClearedEvent() {
  return new CustomEvent("data-catalogue:job-selection-cleared", {
    bubbles: true,
  });
}

function createJobMapFocusRequestedEvent(job) {
  return new CustomEvent("data-catalogue:job-map-focus-requested", {
    bubbles: true,
    detail: {
...
function createJobMapFocusClearedEvent() {
  return new CustomEvent("data-catalogue:job-map-focus-cleared", {
    bubbles: true,
  });
}
...
function createJobDetailsModeChangedEvent({ isDetailsMode, selectedJobId } = {}) {
  return new CustomEvent("data-catalogue:job-details-mode-changed", {
    bubbles: true,
    detail: {
